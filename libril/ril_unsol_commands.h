...
*/
    ...
    {RIL_UNSOL_VOICE_RADIO_TECH_CHANGED_V4, responseInts, WAKE_PARTIAL},
    {0, NULL, WAKE_PARTIAL},                   //none
    {RIL_UNSOL_RESPONSE_IMS_NETWORK_STATE_CHANGED_V4, responseVoid, WAKE_PARTIAL},
